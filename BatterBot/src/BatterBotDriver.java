...
public class BatterBotDriver 
{
	...
	public void cycle()
	{
		...
		while(true)
		{
			...
			if(!input.contains("coordinates") && !input.contains("place") && !input.contains("directions") && !input.contains("image") && !input.contains("map"))
			{
			...
			else if(input.contains("coordinates"))
			{
				geocoding();
			}
	...
	private void map() 
	{
		...
		System.out.println("<Dispatcher> Where are you right now?");
		String location;
		location = scan.nextLine();
		
		Maps map = new Maps();
		map.setAddress(location);
		try 
		{
			map.main(null);
		} 
	...
	private void image() 
	{
		...
		System.out.println("<Dispatcher> Does the image match the location where you are right now (yes/no)?");
		String response;
		response = scan.nextLine();
		
		if(response.equalsIgnoreCase("yes"))
		{
			System.out.println("<Dispatcher> OK. Please stay on the line, and we'll have help there right away.");
			System.out.println("<Dispatcher> Why don't you ask me some questions about Batman while we wait?");
		}
		else
		{
			image();
	...
	private void directions() 
	{
		...
		String to;
		from = scan.nextLine();
		System.out.println("<Dispatcher> And where would you like to go?");
		to = scan.nextLine();
	...
	{
		Scanner scan = new Scanner(System.in);
		System.out.println("<Dispatcher> What place are you looking for?");
		String search;
	...
	{
		Scanner scan = new Scanner(System.in);
		System.out.println("<Dispatcher> At what address are you located?");
		String address;
	...
	public void setup()
	{
		//This is just an example of what a response template definition will look like
				...
				String[] sentence43 = {"Just because. Why don't you ask me about"};
